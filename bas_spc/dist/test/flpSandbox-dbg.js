			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comemamispc-display": {
								"semanticObject": "comemamispc",
								"action": "display",
								"description": "Specification - SPC",
								"title": "Specification Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.emami.spc",
									"url": sap.ui.require.toUrl("com/emami/spc")
								}
							}
						}
					}
